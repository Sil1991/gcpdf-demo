...
public class MinimalWordCountJava8 {
  ...
  public static void main(String[] args) {
    ...
    options.setProject("elegant-atom-181107");
    ...
    p.apply(TextIO.Read.from("gs://jasonlai_bucket1/JasonLai/output_temp/"))
     ...
     .apply(TextIO.Write.to("gs://jasonlai_bucket1/JasonLai/output"));
